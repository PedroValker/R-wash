 ...
 * @author aluno
 */
public class DashBoardClienteAntigo extends javax.swing.JFrame {

    /**
     * Creates new form DashBoardCliente
     * @param idClienteLogado
     */
    public DashBoardClienteAntigo(int idClienteLogado) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashBoardClienteAntigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            new DashBoardClienteAntigo(idClienteTeste).setVisible(true);
        }
    });
    }
