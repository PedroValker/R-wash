 ...
 * @author luizg
 */
public class TelaCadastroMaquinaAntigo extends javax.swing.JFrame {
Maquina objAlterar = null;
    ...
    public TelaCadastroMaquinaAntigo() {
    initComponents();
    ...
    if (sucesso) {
        ...
        TelaCadastroEndereçoAntigo janela = new TelaCadastroEndereçoAntigo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroMaquinaAntigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroMaquinaAntigo().setVisible(true);
            }
        });
    }
