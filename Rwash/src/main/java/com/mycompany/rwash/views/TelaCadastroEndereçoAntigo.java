...
import com.mycompany.rwash.views.DashBoardClienteAntigo;
 ...
 * @author aluno
 */
public class TelaCadastroEndereçoAntigo extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroEndereço
     */
    public TelaCadastroEndereçoAntigo() {
        initComponents();
    ...
    private void btnProsseguirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProsseguirActionPerformed
        ...
        DashBoardClienteAntigo janela = new DashBoardClienteAntigo(idClienteLogado);
    ...
    private void btnCadastroEndereçoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroEndereçoActionPerformed
        ...
        boolean sucesso = EnderecoDAO.salvarEndereco(novoEndereco);
            ...
            DashBoardClienteAntigo dashboard = new DashBoardClienteAntigo(UsuarioDAO.idClienteLogado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroEndereçoAntigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroEndereçoAntigo().setVisible(true);
            }
        });
    }
